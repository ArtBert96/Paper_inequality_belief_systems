...
save(data_final_con, data_final_cat, data_us, data_us_cca, data_nl, data_nl_cca,
     file = here("Output",  "231016 - Data_Databases.RData"))
```
...
tiff(filename  = here("Output", "Article", "Graphs" ,"EGA_multi_freel.tif"), 
     height = 12, width = 12, units = "cm", res = 3000)
lmat <- matrix(1:4, 2, 2)
...
plot_us1_freel = qgraph(ega_us_1$network, 
  ...
  cut = 0.04, title = "US1", 
  # edge.color = c("royalblue", "tomato"),
  maximum = 1, vsize=10.0, label.cex=0.5, vTrans = 150,
