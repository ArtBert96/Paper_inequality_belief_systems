...
#Indexes US
data_us = data_us %>% 
    mutate(index_1 = rowMeans(across(c(p_income, p_wealth, p_poor, p_black, a_diversity, a_equality))),
           index_2 = rowMeans(across(c(e_race, e_sex, e_relig, e_migra))),
           index_3 = rowMeans(across(c(a_merit, e_work, e_edu, e_edupar,
                                       e_weafam, e_people))))

#Indexes NL
data_nl = data_nl %>% 
    mutate(index_1 = rowMeans(across(c(p_income, p_wealth, p_poor, p_black, a_diversity, a_equality, a_merit))),
           index_2 = rowMeans(across(c(e_race, e_sex, e_relig, e_migra))),
           index_3 = rowMeans(across(c(e_work, e_edu, e_edupar,
                                       e_weafam, e_people))))
