...
(-0.03~--~0.23)\strut
\end{minipage} \\
index\_1 & & \begin{minipage}[t]{\linewidth}\raggedright
1.02 \textsuperscript{***}\\
(0.97~--~1.08)\strut
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
1.01 \textsuperscript{***}\\
(0.95~--~1.06)\strut
\end{minipage} \\
index\_2 & & \begin{minipage}[t]{\linewidth}\raggedright
0.20 \textsuperscript{***}\\
(0.14~--~0.27)\strut
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
0.18 \textsuperscript{***}\\
(0.12~--~0.25)\strut
\end{minipage} \\
index\_3 & & \begin{minipage}[t]{\linewidth}\raggedright
-0.00 \textsuperscript{}\\
(-0.10~--~0.09)\strut
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
0.03 \textsuperscript{}\\
