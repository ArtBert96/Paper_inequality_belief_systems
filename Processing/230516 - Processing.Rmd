...
ega_us_full = EGA(data=data_us_ega,  model = "glasso") 
ega_us_full_r = EGA(data=data_us_ega,  model = "glasso") 
CFA(ega_us_full, data_us_ega, estimator = "WLSMV")
CFA(ega_us_full_r, data_us_ega, estimator = "WLSMV")
